...
@Slf4j
@Component
public class OrderSecondDelayCloseProducer extends AbstractCommonSendProduceTemplate<OrderDelayCloseMqDTO> {
    ...
    protected BaseSendExtendDTO buildBaseSendExtendParam(OrderDelayCloseMqDTO messageSendEvent) {
        return BaseSendExtendDTO.builder()
                ...
                .tag(RocketMqConstant.ORDER_SECOND_DELAY_CLOSE_TAG)
                .sentTimeout(2000L)

...
public class TimePeriodTokenCacheLoadTest {
    ...
    private void loadCache(TimePeriodDO timePeriodDO) {
        ...
        timePeriodService.checkBitMapCache(String.format(RedisCacheConstant.VENUE_TIME_PERIOD_FREE_INDEX_BIT_MAP_TOKEN_KEY, timePeriodDO.getId()), timePeriodDO.getId(), partitionDO.getNum());
        // 其次检测时间段库存有没有加载好，没有的话进行加载
        timePeriodService.getStockByTimePeriodId(RedisCacheConstant.VENUE_TIME_PERIOD_STOCK_TOKEN_KEY, timePeriodDO.getId());
    }
}
